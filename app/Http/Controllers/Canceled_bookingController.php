...
class Canceled_bookingController extends Controller
{
    /**
    ...
    public function index()
    {
        //
        //
        $reservations =Reservation::all()->where('state','=','0');




        return view('Receptionist.canceled_booking',compact('reservations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->isMethod('post')){
            ...
            $bo->save();
            return redirect('canceled_booking')->with('success','تم الاضافة بنجاح');
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->isMethod('post')){
            ...
            $bo->update();
            return redirect('canceled_booking')->with('success','تم التحديث بنجاح ');
        }}
    ...
    public function destroy($id)
    {
        ...
        $booking=Reservation::find($id);
        $booking->delete();
        return redirect('canceled_booking')->with('success','تم حذف الحجز بنجاح');
    }
}
