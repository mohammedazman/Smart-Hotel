...
use App\Listener\ConfirmBookingListener;
...
class Manage_bookingController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('Receptionist.reservation',compact('reservations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->isMethod('post')){
            ...
            return redirect('manage_booking')->with('success','تم الاضافة بنجاح');
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->isMethod('post')){
            ...
            $bo->update();
            event(new ConfirmBooking($bo));
            return redirect('manage_booking')->with('success','تم التحديث بنجاح ');
        }}
    ...
    public function destroy($id)
    {
        ...
        $booking=Reservation::find($id);
        $booking->delete();
        return redirect('manage_booking')->with('success','تم حذف الحجز بنجاح');
    }
}
