...
class Manage_orderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Supervisor.order',compact('order','reservation','service'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->isMethod('post')){
            ...
            return redirect('manage_order')->with('success','تم الاضافة بنجاح');
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->isMethod('post')){
            ...
            $or->update();
            event(new FulfillmentOrderEvent($or));
            return redirect('manage_order')->with('success','تم التحديث بنجاح');
    ...
    public function destroy($id)
    {
        ...
        $order=Order::find($id);
        $order->delete();
        return redirect('manage_order')->with('success','تم حذف الطلب بنجاح');
    }
}
