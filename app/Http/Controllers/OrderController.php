...
class OrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Admin.order',compact('order','reservation','service'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->isMethod('post')){
            ...
            return redirect('order')->with('success','تم الاضافة بنجاح');
    ...
    public function edit($id)
    {
        ...
        return view('Admin.order_edit',compact('order','reservation','service'));
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->isMethod('post')){
            ...
            $or->update();
            event(new FulfillmentOrderEvent($or));
            return redirect('order')->with('success','تم التحديث بنجاح');
    ...
    public function destroy($id)
    {
        ...
        $order=Order::find($id);
        $order->delete();
        return redirect('order')->with('success','تم حذف الطلب بنجاح');
    }
}
