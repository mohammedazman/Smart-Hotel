...
class R_BillController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('Receptionist.bill',compact('order','reservation','message','bill'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('Receptionist.bill_edit',compact('order','reservation','bill','message'));
