...
class R_Room_bookingController extends Controller
{
    /**
    ...
    {
        //
        $rooms =Room::all()->where('state','=','2');


        return view('Receptionist.room_booking',compact('rooms'));
    }
...
//add image for room
            ...
            $im->save();
            return redirect('room_booking')->with('success','تم الاضافة بنجاح');
    ...
    public function edit($id)
    {
        ...
        return view('Receptionist.room_edit',$arr);
