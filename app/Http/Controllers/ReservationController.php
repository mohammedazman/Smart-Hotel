...
class ReservationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->isMethod('post')){
            ...
            return redirect('booking')->with('success','تم الاضافة بنجاح');
    ...
    public function edit($id)
    {
        ...
        return view('Admin.reservation_edit')->with('booking',$booking);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->isMethod('post')){
            ...
            $bo->update();
            event(new ConfirmBooking($bo));
            return redirect('booking')->with('success','تم التحديث بنجاح ');
    }}
    ...
    public function destroy($id)
    {
        ...
        $booking=Reservation::find($id);
        $booking->delete();
        return redirect('booking')->with('success','تم حذف الحجز بنجاح');
    }
}
