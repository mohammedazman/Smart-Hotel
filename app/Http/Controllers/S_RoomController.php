...
class S_RoomController extends Controller
{
    /**
    ...
    {
        //
        $rooms =Room::all()->where('state','=','1');


        return view('Supervisor.room',compact('rooms'));
    }
...
//add image for room
            ...
            $im->save();
            return redirect('s_room')->with('success','تم الاضافة بنجاح');
    ...
    public function edit($id)
    {
        ...
        return view('Supervisor.room_edit',$arr);
