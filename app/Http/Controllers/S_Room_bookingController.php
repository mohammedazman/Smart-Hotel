...
class S_Room_bookingController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('Supervisor.room_booking',compact('rooms'));
    }
...
//add image for room
            ...
            $im->save();
            return redirect('s_room_booking')->with('success','تم الاضافة بنجاح');
