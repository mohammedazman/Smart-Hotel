...
class S_ServiceController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('Supervisor.service',compact('services'));
    }
...
//add image for service
            ...
            $sr->save();
            return redirect('s_service')->with('success','تم الاضافة بنجاح');
    ...
    public function edit($id)
    {
        ...
        return view('Supervisor.service_edit')->with('service',$service);
    }
...
//add image for service
    ...
    public function destroy($id)
    {
        ...
        $service=Service::find($id);
        $service->delete();
        return redirect('s_service')->with('success','تم حذف الخدمة بنجاح');
    }
}
